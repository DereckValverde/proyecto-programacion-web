...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/crud-solicitudes.css">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#inicio" data-section="inicio">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="#" data-section="mision">Gestión de Solicitudes</a>
                    </li>
                    <li class="nav-item">
